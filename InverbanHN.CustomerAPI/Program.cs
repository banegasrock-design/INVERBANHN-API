...
// Integration Services: PixelPay Pasarela de Pagos
builder.Services.Configure<InverbanHN.Shared.Options.PixelPaySettings>(builder.Configuration.GetSection("PixelPay"));
builder.Services.AddHttpClient<IPixelPayService, PixelPayService>();
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "InverbanHN CustomerAPI", Version = "v1" });
});
